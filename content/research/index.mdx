...
**The following essays were published on the earlier version of this digital project and they pertain to the religious buildings connected to the Guild of Painters, and then to the Accademia di San Luca.
Their location spread across the central area of the city of Rome and they were used by artists at different times.
Click on the links below to go to each essay--available in English and in Italian (same link).**

*Please note*: extended bibliographies can be found in the [project bibliography repository](https://www.zotero.org/groups/5626268/accademia_di_san_luca/library); maps mentioned in the essays can be found on [this same site](https://nationalgalleryofart.github.io/accademia-research/search?type=work&document-type=map).
